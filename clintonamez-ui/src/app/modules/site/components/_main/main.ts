...
@Component({
  ...
  export class MainComponent {    
    ...
    public navitems: CmsNavModel[] = [
      new CmsNavModel("about us", null, 'site/about-us', [new CmsNavModel("our history", null, 'site/about-us/our-history', null, false), new CmsNavModel("our clergy", null, 'site/about-us/our-clergy', null, false),new CmsNavModel("service information", null, 'site/about-us/our-service', null, false),new CmsNavModel("inside zion", null, 'http://www.amez.org/', null,true)], false),
      new CmsNavModel("pastors page", null, 'site/pastors-page', null, false),
      new CmsNavModel("ministries", null, 'site/ministries', null, false),
      ...
      new CmsNavModel("get connected", null, 'site/get-connected', null, false),
