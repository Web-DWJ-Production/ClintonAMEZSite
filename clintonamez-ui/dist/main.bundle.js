...
var AnnouncementsComponent = (function () {
    function AnnouncementsComponent(authService, coreService) {
        this.authService = authService;
        this.coreService = coreService;
        this.uploader = new __WEBPACK_IMPORTED_MODULE_1_ng2_file_upload__["FileUploader"]({ url: this.coreService.getUploadUrl('announcements') });
        this.cardMax = 5;
    }
    ...
    AnnouncementsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__services_authServices__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_5__services_coreServices__["a" /* CoreService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_templates_eventDialog__ = __webpack_require__("./src/app/modules/site/components/templates/eventDialog.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.loadAnnouncements = function () {
        ...
        this.coreService.getAnnouncements(function (res) {
            if (res.errorMessage == null) {
                ...
                self.homeCards.unshift(new __WEBPACK_IMPORTED_MODULE_2__datamodels_announcementModel__["a" /* AnnouncementModel */](0, "", "cover-title", "Welcome To Clinton", []));
            }
        });
    };
    ...
    HomeComponent.prototype.openEvent = function (evnt) {
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_4__components_templates_eventDialog__["a" /* EventDialogComponent */], {
            width: '75%',
            data: evnt
        });
    };
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__services_coreServices__["a" /* CoreService */], __WEBPACK_IMPORTED_MODULE_1__angular_material__["i" /* MatDialog */]])
    ], HomeComponent);
    return HomeComponent;
}());
...
var CoreService = (function () {
    ...
    CoreService.prototype.getAnnouncements = function (callback) {
        var vidAnnouncement = new __WEBPACK_IMPORTED_MODULE_2__datamodels_announcementModel__["a" /* AnnouncementModel */](5, "assets/images/tmpMedia/tmpVideo.mp4", "full-video", null, null);
