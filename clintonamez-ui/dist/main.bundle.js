...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_authServices__ = __webpack_require__("./src/app/services/authServices.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__services_coreServices__ = __webpack_require__("./src/app/services/coreServices.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__datamodels_cmsNavModel__ = __webpack_require__("./src/app/datamodels/cmsNavModel.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CMSCoreComponent = (function () {
    function CMSCoreComponent(router, zone, componentFactoryResolver, authService) {
        ...
        this.cmsNavItems = {
            ...
            "announcements": { "navItem": new __WEBPACK_IMPORTED_MODULE_11__datamodels_cmsNavModel__["a" /* CmsNavModel */]('announcements', 'fa-bullhorn', 'announcements', null, false), "template": __WEBPACK_IMPORTED_MODULE_5__home_home__["a" /* HomeComponent */] },
            "ministries": { "navItem": new __WEBPACK_IMPORTED_MODULE_11__datamodels_cmsNavModel__["a" /* CmsNavModel */]('ministries', 'fa-child', 'ministries', null, false), "template": __WEBPACK_IMPORTED_MODULE_9__ministries_ministries__["a" /* MinistriesComponent */] },
            "gallery": { "navItem": new __WEBPACK_IMPORTED_MODULE_11__datamodels_cmsNavModel__["a" /* CmsNavModel */]('gallery', 'fa-images', 'gallery', null, false), "template": __WEBPACK_IMPORTED_MODULE_10__gallery_gallery__["a" /* GalleryComponent */] },
            "calender": { "navItem": new __WEBPACK_IMPORTED_MODULE_11__datamodels_cmsNavModel__["a" /* CmsNavModel */]('calender', 'fa-calendar-alt', 'calender', null, false), "template": __WEBPACK_IMPORTED_MODULE_8__calendar_calendar__["a" /* CalendarComponent */] },
            "forms": { "navItem": new __WEBPACK_IMPORTED_MODULE_11__datamodels_cmsNavModel__["a" /* CmsNavModel */]('forms', 'fa-clipboard', 'forms', null, false), "template": __WEBPACK_IMPORTED_MODULE_5__home_home__["a" /* HomeComponent */] }
        };
        this.userInfo = null;
        this.navData = {
            "displayList": [],
...
var GalleryComponent = (function () {
    function GalleryComponent(authService, coreService, chRef) {
        ...
        this.coreService = coreService;
        this.chRef = chRef;
        this.uploader = new __WEBPACK_IMPORTED_MODULE_2_ng2_file_upload__["FileUploader"]({ url: this.coreService.getUploadImagesUrl() });
        this.galleryObject = {
            selected: null,
            list: [],
            page: 0,
...
var CoreService = (function () {
    ...
    /* CMS */
    CoreService.prototype.getUploadImagesUrl = function () {
